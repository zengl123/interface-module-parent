...
public final class Comm {
    ...
    public enum EventState
        ...
        public static EventState valueOf(int value) {
            switch (value) {
                case 0:
                    return EVENT_STATE_INSTANT;
                case 1:
                    return EVENT_STATE_START;
                case 2:
                    return EVENT_STATE_STOP;
                case 3:
                    return EVENT_STATE_PULSE;
                case 4:
        ...
        public static EnumLiteMap<EventState>
        internalGetValueMap() {
            return internalValueMap;
        }

        private static EnumLiteMap<EventState>
                internalValueMap =
                number -> EventState.valueOf(number);
        ...
        public static EventState valueOf(Descriptors.EnumValueDescriptor desc) {
        ...
        EventState(int index, int value) {
            this.index = index;
            this.value = value;
        }
    ...
    public enum MsgCmdType implements ProtocolMessageEnum {
        ...
        public static MsgCmdType valueOf(int value) {
            switch (value) {
                case 65280:
                    return MSG_CMD_TYPE_MASK;
                case 257:
                    return MSG_CMD_MANUAL_EVENT;
                case 258:
                    return MSG_CMD_CONFIRM_EVENT;
                case 513:
                    return MSG_CMD_REPORT_EVENT;
                case 514:
                    return MSG_CMD_SUBRECV_EVENT;
                case 769:
                    return MSG_CMD_EVENT_NOTIFY_REQ;
                case 770:
                    return MSG_CMD_EVENT_NOTIFY_RSP;
                default:
                    return null;
            }
        }

        public static EnumLiteMap<MsgCmdType>
        internalGetValueMap() {
            return internalValueMap;
        }

        private static EnumLiteMap<MsgCmdType>
                internalValueMap =
                number -> MsgCmdType.valueOf(number);
        ...
        public static MsgCmdType valueOf(Descriptors.EnumValueDescriptor desc) {
            if (desc.getType() != getDescriptor()) {
                throw new IllegalArgumentException("EnumValueDescriptor is not for this type.");
            }
            return VALUES[desc.getIndex()];
        ...
        MsgCmdType(int index, int value) {
            this.index = index;
            this.value = value;
        }
    ...
    public static final class TriggerResult extends GeneratedMessage {
        ...
        getDescriptor() {
            return Comm.internal_static_TriggerResult_descriptor;
        }

        @Override
        protected FieldAccessorTable internalGetFieldAccessorTable() {
            return Comm.internal_static_TriggerResult_fieldAccessorTable;
        }
        ...
        private List<Integer> triggerRet_ = Collections.emptyList();
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (hasTriggerType()) {
                size += CodedOutputStream.computeInt32Size(1, getTriggerType());
            }
            {
                int dataSize = 0;
                for (int element : getTriggerRetList()) {
        ...
        public static final class Builder extends
            ...
            // Construct using Comm.TriggerResult.newBuilder()
            private Builder() {
            }
            ...
            // @@protoc_insertion_point(builder_scope:TriggerResult)
        }
        ...
        // @@protoc_insertion_point(class_scope:TriggerResult)
    }
    ...
    public static final class CommEventTrig extends
        ...
        public static final Descriptors.Descriptor
        getDescriptor() {
            return Comm.internal_static_CommEventTrig_descriptor;
        }

        protected FieldAccessorTable
        internalGetFieldAccessorTable() {
            return Comm.internal_static_CommEventTrig_fieldAccessorTable;
        }
        ...
        private boolean hasTriggerInfo;
        private ByteString triggerInfo_ = ByteString.EMPTY;

        public boolean hasTriggerInfo() {
            return hasTriggerInfo;
        }

        public ByteString getTriggerInfo() {
            return triggerInfo_;
        }
        ...
        public static final class Builder extends
            ...
            // Construct using Comm.CommEventTrig.newBuilder()
            private Builder() {
            }
            ...
            public Builder setTriggerInfo(ByteString value) {
                if (value == null) {
                    throw new NullPointerException();
                }
                result.hasTriggerInfo = true;
            ...
            // @@protoc_insertion_point(builder_scope:CommEventTrig)
        }
        ...
        // @@protoc_insertion_point(class_scope:CommEventTrig)
    }

    private static Descriptors.Descriptor
            internal_static_TriggerResult_descriptor;
    private static
    GeneratedMessage.FieldAccessorTable
            internal_static_TriggerResult_fieldAccessorTable;
    private static Descriptors.Descriptor
            internal_static_CommEventTrig_descriptor;
    private static
    GeneratedMessage.FieldAccessorTable
            internal_static_CommEventTrig_fieldAccessorTable;
        ...
        Descriptors.FileDescriptor.InternalDescriptorAssigner assigner =
                new Descriptors.FileDescriptor.InternalDescriptorAssigner() {
                    public ExtensionRegistry assignDescriptors(
                        ...
                        internal_static_TriggerResult_fieldAccessorTable = new
                                GeneratedMessage.FieldAccessorTable(
                                internal_static_TriggerResult_descriptor,
                        ...
                        internal_static_CommEventTrig_fieldAccessorTable = new
                                GeneratedMessage.FieldAccessorTable(
                                internal_static_CommEventTrig_descriptor,
